...
print("Generated Test Data Shape:", X_test.shape)
# Print the generated test data, actual values, and predicted values
print("Generated Test Data with Actual and Predicted Values:")
